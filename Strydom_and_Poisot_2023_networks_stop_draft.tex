...
\raggedright
\thispagestyle{empty}
{\Large\bfseries\sffamily Where do networks stop?}
\vskip 5em
...
(\textbf{Kopelke2017FooStr?}). This dataset consists of replicate
samples of \emph{Salix} (willow species) -- willow-galling sawfly --
predator interactions across Europe. Data collection spanned 29 years
across 641 sites (some with repeat visits) revealing 1 173 links across
sites and trophic levels. Sites spanned a large latitudinal (in the
context of continental Europe) from Italy (39.00\(/deg\) N) to Norway
